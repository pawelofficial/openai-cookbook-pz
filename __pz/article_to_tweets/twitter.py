...
#os.environ['BEARER_TOKEN']='xxx%xxx%xxxx'
#os.environ['ACCESS_TOKEN']='xxx-xxx'
#os.environ['ACCESS_TOKEN_SECRET']='xxx'
#
#os.environ['CLIENT_SECRET']='xxxx'
